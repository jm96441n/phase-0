...
//Why did that work?
//At first I had problems removing the eyeColor from terah. At first I just 
// tried to re-assign the value of eyeColor to null or undefined, but that did
// not work. So I used the delete function on the item.
//2) How difficult was it to add and delete properties from outside of the object 
// itself?
//It was not too difficult once I figured out the syntax.
//3) What did you learn about manipulating objects in this challenge?
//I learned a lot about the JavaScript syntax in this challenge.
